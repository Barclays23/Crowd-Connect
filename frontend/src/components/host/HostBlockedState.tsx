  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-(--bg-primary) px-4 py-12">
      <div className="max-w-md w-full rounded-2xl p-8 text-center bg-(--card-bg) border border-(--card-border) shadow-(--shadow-lg)">
        ...
        {/* Icon */}
        <div className="w-20 h-20 mx-auto mb-6 rounded-full flex items-center justify-center bg-(--badge-error-bg)">
          <Ban className="w-10 h-10 text-(--status-error)" />
        </div>
        ...
        {/* Info Box */}
        <div className="rounded-xl p-4 mb-6 bg-(--badge-error-bg) border border-(--badge-error-border)">
          <div className="flex items-start gap-3 text-left">
            <AlertOctagon className="w-5 h-5 shrink-0 mt-0.5 text-(--badge-error-text)" />
            <p className="text-sm text-(--badge-error-text)">
        ...
        <button
          disabled
          className="w-full flex items-center justify-center gap-2 px-6 py-3 rounded-xl font-semibold opacity-50 cursor-not-allowed mb-4 bg-(--btn-primary-bg) text-(--btn-primary-text)"
        >
