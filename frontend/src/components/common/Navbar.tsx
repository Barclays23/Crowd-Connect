...
export function Navbar() {
   ...
   return (
      <header className="border-b border-[var(--border-default)] bg-[var(--bg-primary)]/95 backdrop-blur supports-[backdrop-filter]:bg-[var(--bg-primary)]/60 sticky top-0 z-50">
         ...
         <div
            ref={drawerRef}
            className={`fixed inset-y-0 left-0 w-64 bg-[var(--bg-primary)] border-r border-[var(--border-default)] transform transition-transform duration-300 ease-in-out z-40 md:hidden ${
