...
export class BookingController implements IBookingController{
   ...
   async initiateBooking(req: Request, res: Response, next: NextFunction): Promise<void> {
      try {
         ...
         const apiResponse: ApiResponse<InitiateBookingResponseDTO> = ApiResponse.success<InitiateBookingResponseDTO>(
            BOOKING_MESSAGES.BOOKING_INITIATED, 
            result  // (isFree + populatedBooking) OR (isFree + order)
         )
   ...
   async retryPayment(req: Request, res: Response, next: NextFunction): Promise<void> {
      try {
         ...
         const result: InitiateBookingResponseDTO = await this._bookingService.retryPayment(bookingId, userId, paymentMethod);
   ...
   async getMyBookings(req: Request, res: Response, next: NextFunction): Promise<void> {
      try {
         ...
         res.status(HTTP_STATUS.OK).json(
            ApiResponse.success<BookingResponseDTO[]>(
