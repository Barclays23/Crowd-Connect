...
import { PAYMENT_METHODS, PaymentMethod, PaymentStatus } from "@/constants/payment.constants";
...
// Returned for all booking detail views (after booking confirmation)
...
export type InitiateBookingResponseDTO =
  | { 
      paymentMethod   : typeof PAYMENT_METHODS.NONE;
      isFree          : true; 
      populatedBooking: BookingResponseDTO; // confirmed, has QR
    }
  | { 
      paymentMethod   : typeof PAYMENT_METHODS.WALLET;
      isFree          : false; 
      populatedBooking: BookingResponseDTO; // confirmed, has QR
    }
  | { 
      paymentMethod   : typeof PAYMENT_METHODS.ONLINE;
      isFree          : false; 
      order           : BookingOrderResponseDTO; // pending, needs payment & varify payment
    };
